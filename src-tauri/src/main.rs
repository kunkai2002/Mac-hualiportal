...
fn main() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            // 啟動內嵌本地文件橋（127.0.0.1:3710）：門戶頁面 fetch 即可訪問本地文件，無需 Node/IPC。
            serve::start_bridge();
            ...
            let menu = Menu::with_items(app, &[&show, &sep1, &m_home, &m_pm, &m_fs, &m_cal, &m_sheets, &sep2, &quit])?;
